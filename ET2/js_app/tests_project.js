let def_tests_project = Array(
    ...
    Array("project", "start_date_project", 21, "Cumple tener formato dd/mm/aaaa o una substring o ser vacio", "SEARCH", 'start_date_project_format_KO', 'El formato de la Fecha de Inicio es incorrecto, debe ser al menos una parte de una fecha dd/mm/yyyy.'),
    ...
    Array("project", "end_date_project", 29, "Cumple tener formato dd/mm/aaaa o una substring o ser vacio", "SEARCH", 'end_date_project_format_KO', 'El formato de la Fecha de Fin es incorrecto, debe ser al menos una parte de una fecha dd/mm/yyyy.'),
...
let pruebas_project = Array(
    ...
    //codigo respuesta = entidad_campo_tipoTest_resultado
    ...
    //SEARCH
    Array("project", "id_project", 1, 1, "SEARCH", "2".repeat(12), "id_project_max_size_KO"),
    Array("project", "id_project", 1, 2, "SEARCH", "2".repeat(13), "id_project_max_size_KO"),

    Array("project", "id_project", 2, 3, "SEARCH", "texto", "id_project_format_KO"),
    Array("project", "id_project", 2, 4, "SEARCH", "11.9", "id_project_format_KO"),
    Array("project", "id_project", 2, 5, "SEARCH", "11/9", "id_project_format_KO"),
    Array("project", "id_project", 2, 6, "SEARCH", "-1", "id_project_format_KO"),
    ...
    Array("project", "name_project", 4, 14, "ADD", "a".repeat(6), "name_project_min_size_KO"),
    ...
    Array("project", "name_project", 5, 17, "ADD", "a".repeat(102), "name_project_max_size_KO"),

    Array("project", "name_project", 6, 18, "ADD", "Análisis".repeat(2), "name_project_format_KO"),
    Array("project", "name_project", 6, 19, "ADD", "Analisis Datos A Coruña", "name_project_format_KO"),
    Array("project", "name_project", 6, 20, "ADD", "Analisis 45".repeat(2), "name_project_format_KO"),
    Array("project", "name_project", 6, 21, "ADD", "Analisis.".repeat(2), "name_project_format_KO"),
    ...
    Array("project", "name_project", 10, 34, "EDIT", "Analisis Datos A Coruña", "name_project_format_KO"),
    Array("project", "name_project", 10, 35, "EDIT", "Analisis 45".repeat(2), "name_project_format_KO"),
    Array("project", "name_project", 10, 36, "EDIT", "Analisis.".repeat(2), "name_project_format_KO"),
    ...
    Array("project", "name_project", 13, 46, "SEARCH", "Analisis Datos A Coruña", "name_project_format_KO"),
    Array("project", "name_project", 13, 47, "SEARCH", "Analisis 45".repeat(2), "name_project_format_KO"),
    Array("project", "name_project", 13, 48, "SEARCH", "Analisis.".repeat(2), "name_project_format_KO"),
    ...
    //ADD
    Array("project", "start_date_project", 15, 56, "ADD", "02-11-2004", "start_date_project_format_KO"),
    Array("project", "start_date_project", 15, 57, "ADD", "2004-02-11", "start_date_project_format_KO"),
    Array("project", "start_date_project", 15, 58, "ADD", "01/marzo/2020", "start_date_project_format_KO"),
    Array("project", "start_date_project", 15, 59, "ADD", "1/02/2004", "start_date_project_format_KO"),
    Array("project", "start_date_project", 15, 60, "ADD", "11/2/2004", "start_date_project_format_KO"),
    Array("project", "start_date_project", 15, 61, "ADD", "0020/02/01", "start_date_project_format_KO"),
    Array("project", "start_date_project", 15, 62, "ADD", "02/0002/01", "start_date_project_format_KO"),
    Array("project", "start_date_project", 15, 63, "ADD", "25/12/01", "start_date_project_format_KO"),
    Array("project", "start_date_project", 15, 64, "ADD", "02-11-04", "start_date_project_format_KO"),
    Array("project", "start_date_project", 15, 65, "ADD", "1 de enero de 1970", "start_date_project_format_KO"),
    Array("project", "start_date_project", 15, 66, "ADD", "01,12,2000", "start_date_project_format_KO"),

    Array("project", "start_date_project", 16, 67, "ADD", "00/11/2020", "start_date_project_valid_KO"),
    Array("project", "start_date_project", 16, 68, "ADD", "02/00/2020", "start_date_project_valid_KO"),
    ...
    //EDIT
    Array("project", "start_date_project", 18, 79, "EDIT", "02-11-2004", "start_date_project_format_KO"),
    Array("project", "start_date_project", 18, 80, "EDIT", "2004-02-11", "start_date_project_format_KO"),
    Array("project", "start_date_project", 18, 81, "EDIT", "01/marzo/2020", "start_date_project_format_KO"),
    Array("project", "start_date_project", 18, 82, "EDIT", "1/02/2004", "start_date_project_format_KO"),
    Array("project", "start_date_project", 18, 83, "EDIT", "11/2/2004", "start_date_project_format_KO"),
    Array("project", "start_date_project", 18, 84, "EDIT", "0020/02/01", "start_date_project_format_KO"),
    Array("project", "start_date_project", 18, 85, "EDIT", "02/0002/01", "start_date_project_format_KO"),
    Array("project", "start_date_project", 18, 86, "EDIT", "25/12/01", "start_date_project_format_KO"),
    Array("project", "start_date_project", 18, 87, "EDIT", "02-11-04", "start_date_project_format_KO"),
    Array("project", "start_date_project", 18, 88, "EDIT", "1 de enero de 1970", "start_date_project_format_KO"),
    Array("project", "start_date_project", 18, 89, "EDIT", "01,12,2000", "start_date_project_format_KO"),
    ...
    //SEARCH
    Array("project", "start_date_project", 21, 102, "SEARCH", "02-11-2004", "start_date_project_format_KO"),
    Array("project", "start_date_project", 21, 103, "SEARCH", "2004-02-11", "start_date_project_format_KO"),
    Array("project", "start_date_project", 21, 104, "SEARCH", "01/marzo/2020", "start_date_project_format_KO"),
    ...
    Array("project", "start_date_project", 21, 107, "SEARCH", "02-11-04", "start_date_project_format_KO"),
    Array("project", "start_date_project", 21, 108, "SEARCH", "1 de enero de 1970", "start_date_project_format_KO"),
    Array("project", "start_date_project", 21, 109, "SEARCH", "01,12,2000", "start_date_project_format_KO"),
    ...
    //ADD
    Array("project", "end_date_project", 23, 123, "ADD", "02-11-2004", "end_date_project_format_KO"),
    Array("project", "end_date_project", 23, 124, "ADD", "2004-02-11", "end_date_project_format_KO"),
    Array("project", "end_date_project", 23, 125, "ADD", "01/marzo/2020", "end_date_project_format_KO"),
    Array("project", "end_date_project", 23, 126, "ADD", "1/02/2004", "end_date_project_format_KO"),
    Array("project", "end_date_project", 23, 127, "ADD", "11/2/2004", "end_date_project_format_KO"),
    Array("project", "end_date_project", 23, 128, "ADD", "0020/02/01", "end_date_project_format_KO"),
    Array("project", "end_date_project", 23, 129, "ADD", "02/0002/01", "end_date_project_format_KO"),
    Array("project", "end_date_project", 23, 130, "ADD", "25/12/01", "end_date_project_format_KO"),
    Array("project", "end_date_project", 23, 131, "ADD", "02-11-04", "end_date_project_format_KO"),
    Array("project", "end_date_project", 23, 132, "ADD", "1 de enero de 1970", "end_date_project_format_KO"),
    Array("project", "end_date_project", 23, 133, "ADD", "01,12,2000", "end_date_project_format_KO"),
    ...
    //EDIT
    Array("project", "end_date_project", 26, 146, "EDIT", "02-11-2004", "end_date_project_format_KO"),
    Array("project", "end_date_project", 26, 147, "EDIT", "2004-02-11", "end_date_project_format_KO"),
    Array("project", "end_date_project", 26, 148, "EDIT", "01/marzo/2020", "end_date_project_format_KO"),
    Array("project", "end_date_project", 26, 149, "EDIT", "1/02/2004", "end_date_project_format_KO"),
    Array("project", "end_date_project", 26, 150, "EDIT", "11/2/2004", "end_date_project_format_KO"),
    Array("project", "end_date_project", 26, 151, "EDIT", "0020/02/01", "end_date_project_format_KO"),
    Array("project", "end_date_project", 26, 152, "EDIT", "02/0002/01", "end_date_project_format_KO"),
    Array("project", "end_date_project", 26, 153, "EDIT", "25/12/01", "end_date_project_format_KO"),
    Array("project", "end_date_project", 26, 154, "EDIT", "02-11-04", "end_date_project_format_KO"),
    Array("project", "end_date_project", 26, 155, "EDIT", "1 de enero de 1970", "end_date_project_format_KO"),
    Array("project", "end_date_project", 26, 156, "EDIT", "01,12,2000", "end_date_project_format_KO"),
    ...
    //SEARCH
    Array("project", "end_date_project", 29, 169, "SEARCH", "02-11-2004", "end_date_project_format_KO"),
    Array("project", "end_date_project", 29, 170, "SEARCH", "2004-02-11", "end_date_project_format_KO"),
    Array("project", "end_date_project", 29, 171, "SEARCH", "01/marzo/2020", "end_date_project_format_KO"),
    ...
    Array("project", "end_date_project", 29, 174, "SEARCH", "02-11-04", "end_date_project_format_KO"),
    Array("project", "end_date_project", 29, 175, "SEARCH", "1 de enero de 1970", "end_date_project_format_KO"),
    Array("project", "end_date_project", 29, 176, "SEARCH", "01,12,2000", "end_date_project_format_KO"),
    ...
    Array("project", "responsable_project", 33, 195, "ADD", "123456", "responsable_project_format_KO"),
    Array("project", "responsable_project", 33, 196, "ADD", "PROYECTO SUPER SECRETO ?", "responsable_project_format_KO"),
    Array("project", "responsable_project", 33, 197, "ADD", "PROYECTO SUPER SECRETO .", "responsable_project_format_KO"),
    ...
    Array("project", "responsable_project", 37, 208, "EDIT", "123456", "responsable_project_format_KO"),
    Array("project", "responsable_project", 37, 209, "EDIT", "PROYECTO SUPER SECRETO ?", "responsable_project_format_KO"),
    Array("project", "responsable_project", 37, 210, "EDIT", "PROYECTO SUPER SECRETO .", "responsable_project_format_KO"),
    ...
    Array("project", "responsable_project", 40, 218, "SEARCH", "123456", "responsable_project_format_KO"),
    Array("project", "responsable_project", 40, 219, "SEARCH", "PROYECTO SUPER SECRETO ?", "responsable_project_format_KO"),
    Array("project", "responsable_project", 40, 220, "SEARCH", "PROYECTO SUPER SECRETO .", "responsable_project_format_KO"),
    ...
    Array("project", "organization_project", 44, 232, "ADD", "123456", "organization_project_format_KO"),
    Array("project", "organization_project", 44, 233, "ADD", "PROYECTO SUPER SECRETO ?", "organization_project_format_KO"),
    Array("project", "organization_project", 44, 234, "ADD", "PROYECTO SUPER SECRETO .", "organization_project_format_KO"),
    ...
    Array("project", "organization_project", 48, 245, "EDIT", "123456", "organization_project_format_KO"),
    Array("project", "organization_project", 48, 246, "EDIT", "PROYECTO SUPER SECRETO ?", "organization_project_format_KO"),
    Array("project", "organization_project", 48, 247, "EDIT", "PROYECTO SUPER SECRETO .", "organization_project_format_KO"),
    ...
    Array("project", "organization_project", 51, 255, "SEARCH", "123456", "organization_project_format_KO"),
    Array("project", "organization_project", 51, 256, "SEARCH", "PROYECTO SUPER SECRETO ?", "organization_project_format_KO"),
    Array("project", "organization_project", 51, 257, "SEARCH", "PROYECTO SUPER SECRETO .", "organization_project_format_KO"),
    ...
    Array("project", "code_project", 63, 318, "ADD", "123456", "code_project_format_KO"),
    Array("project", "code_project", 63, 319, "ADD", "PROYECTO SUPER SECRETÓ", "code_project_format_KO"),
    ...
    Array("project", "code_project", 67, 330, "EDIT", "123456", "code_project_format_KO"),
    Array("project", "code_project", 67, 331, "EDIT", "PROYECTO SUPER SECRETÓ", "code_project_format_KO"),
    ...
    Array("project", "code_project", 70, 339, "SEARCH", "123456", "code_project_format_KO"),
    Array("project", "code_project", 70, 340, "SEARCH", "PROYECTO SUPER SECRETÓ", "code_project_format_KO"),
    ...
    Array("project", "acronym_project", 74, 352, "ADD", "123456", "acronym_project_format_KO"),
    Array("project", "acronym_project", 74, 353, "ADD", "SECRETÓ", "acronym_project_format_KO"),
    Array("project", "acronym_project", 74, 354, "ADD", "SECRET A", "acronym_project_format_KO"),
    ...
    Array("project", "acronym_project", 78, 365, "EDIT", "123456", "acronym_project_format_KO"),
    Array("project", "acronym_project", 78, 366, "EDIT", "SECRETÓ", "acronym_project_format_KO"),
    Array("project", "acronym_project", 78, 367, "EDIT", "SECRET A", "acronym_project_format_KO"),
    ...
    Array("project", "acronym_project", 81, 375, "SEARCH", "123456", "acronym_project_format_KO"),
    Array("project", "acronym_project", 81, 376, "SEARCH", "SECRETÓ", "acronym_project_format_KO"),
    Array("project", "acronym_project", 81, 377, "SEARCH", "SECRET A", "acronym_project_format_KO"),
    ...
    Array("project", "id_sampling_methodology", 85, 389, "ADD", "11.9", "id_sampling_methodology_format_KO"),
    Array("project", "id_sampling_methodology", 85, 390, "ADD", "11/9", "id_sampling_methodology_format_KO"),
    Array("project", "id_sampling_methodology", 85, 391, "ADD", "-1", "id_sampling_methodology_format_KO"),
    ...
    Array("project", "id_sampling_methodology", 88, 399, "EDIT", "2".repeat(12), "id_sampling_methodology_max_size_KO"),
    Array("project", "id_sampling_methodology", 88, 400, "EDIT", "2".repeat(13), "id_sampling_methodology_max_size_KO"),

    Array("project", "id_sampling_methodology", 89, 401, "EDIT", "texto", "id_sampling_methodology_format_KO"),
    ...
    Array("project", "id_sampling_methodology", 92, 412, "SEARCH", "texto", "id_sampling_methodology_format_KO"),
    Array("project", "id_sampling_methodology", 92, 413, "SEARCH", "11.9", "id_sampling_methodology_format_KO"),
    ...
    Array("project", "file_project", 94, 423, "SEARCH", "a".repeat(102), "file_project_max_size_KO"),

    Array("project", "file_project", 95, 424, "SEARCH", "archivo45", "file_project_format_KO"),
    Array("project", "file_project", 95, 425, "SEARCH", "Saludos\nEsto deberia petar", "file_project_format_KO"),
    Array("project", "file_project", 95, 426, "SEARCH", "Saludos\tEsto deberia petar", "file_project_format_KO"),
    Array("project", "file_project", 95, 427, "SEARCH", "archivoÑ", "file_project_format_KO"),
    ...
    Array("project", "file_project", 95, 431, "SEARCH", "archivo/", "file_project_format_KO"),
...
let pruebas_file_project = Array(
    ...
    Array("project", "nuevo_file_project", 100, 449, "ADD", "format_name_file", Array("archivo45", Array("application/pdf"), 1234), "nuevo_file_project_format_name_file_KO"),
    Array("project", "nuevo_file_project", 100, 450, "ADD", "format_name_file", Array("Saludos\nEsto deberia petar", Array("application/pdf"), 1234), "nuevo_file_project_format_name_file_KO"),
    Array("project", "nuevo_file_project", 100, 451, "ADD", "format_name_file", Array("Saludos\tEsto deberia petar", Array("application/pdf"), 1234), "nuevo_file_project_format_name_file_KO"),
    Array("project", "nuevo_file_project", 100, 452, "ADD", "format_name_file", Array("archivoÑ", Array("application/pdf"), 1234), "nuevo_file_project_format_name_file_KO"),
    ...
    Array("project", "nuevo_file_project", 100, 456, "ADD", "format_name_file", Array("archivo/", Array("application/pdf"), 1234), "nuevo_file_project_format_name_file_KO"),
    ...
    Array("project", "nuevo_file_project", 107, 483, "EDIT", "format_name_file", Array("archivo45", Array("application/pdf"), 1234), "nuevo_file_project_format_name_file_KO"),
    Array("project", "nuevo_file_project", 107, 484, "EDIT", "format_name_file", Array("Saludos\nEsto deberia petar", Array("application/pdf"), 1234), "nuevo_file_project_format_name_file_KO"),
    Array("project", "nuevo_file_project", 107, 485, "EDIT", "format_name_file", Array("Saludos\tEsto deberia petar", Array("application/pdf"), 1234), "nuevo_file_project_format_name_file_KO"),
    Array("project", "nuevo_file_project", 107, 486, "EDIT", "format_name_file", Array("archivoÑ", Array("application/pdf"), 1234), "nuevo_file_project_format_name_file_KO"),
    ...
    Array("project", "nuevo_file_project", 107, 490, "EDIT", "format_name_file", Array("archivo/", Array("application/pdf"), 1234), "nuevo_file_project_format_name_file_KO"),
